...
(2) no debe tener deudas pendientes. Si cumple estas condiciones, el préstamo se aprueba; en caso contrario, se rechaza."
"""
...
# Operadores lógicos
if (ingreso_mensual >2000 or puntuacion_credito >= 650) or deuda == 0:
